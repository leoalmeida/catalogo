...
function executaRelatorio(pagina) {
	...
	$.ajax({
	   ...
	   success: function(xml){
		...
		$('#frameMain').html($(xml).find('#maindata').get());
	...
	$.ajax({
	   ...
	   success: function(xml){
		...
		$(xml).find('leaf').each(function(index){			
			var sName = $(this).attr('name');
			var sLink = $(this).find('link').attr('url');
			htmlCode = htmlCode + "<li data-jstree='{\"icon\":\"file file-xls\"}'><a href='#' onClick=\"executaRelatorio('"+sLink+"')\">"+sName+"</a></li>";
	...
	$.ajax({
	   ...
	   success: function(xml){
		...
		$(xml).find('folder').each(function(index){
			var sName = $(this).attr('name');
			var sLink = $(this).find('link').attr('url');
			htmlCode = htmlCode + "<li data-jstree='{\"icon\":\"file\"}'><a href='#' onClick=\"executaServico('"+sLink+"')\">"+sName+"</a></li>"; 			// + "<li data-jstree='{\"icon\":\"file\"}'><a href='../"+sLink+"' target=\"frameMain\">"+sName+"</a></li>";			
		});
